...
export function detectPages(text: string, fileType: SupportedFileType): DocumentPage[] {
...
export function createChunks(text: string, sections: DocumentSection[]): DocumentChunk[] {
...
export function detectJurisdiction(text: string): string | undefined {
  const patterns = [
